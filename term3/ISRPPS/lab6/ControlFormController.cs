...
namespace ISRPPS_Lab_6
{
    public class ControlFormController
    {
        ...
        public ControlFormController(ControlForm view, LaunchModel model)
        {
            this.model = model;
            this.view = view;
        }
        ...
        {
            if (model.SwitchedOn) throw new Exception("Невозможно изменить интервалы в запущенной ракете!");
